...
for item in (parseddoc["findCompletedItemsResponse"][0]["searchResult"][0]["item"]):
    ...
    if sales == "EndedWithSales": #prints only SOLD items -- change to EndedWithoutSales or remove completely if want to see all ended listings
        print(title + " " + price + " " + condition + " " + itemurl + " " + sales + " " + end)